...
yay -S rofi hyper unrar detect-it-easy-git nmap zsh zsh-theme-powerlevel10k-git bluez bluez-utils blueman visual-studio-code-bin alacritty nautilus pavucontrol waybar hyprpaper hyprshot wlogout nwg-look-bin nautilus hyprshot unzip brightnessctl xsensors
