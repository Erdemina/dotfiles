...
yay -S rofi hyper visual-studio-code-bin alacritty nautilus pavucontrol waybar hyprpaper hyprshot wlogout nwg-look-bin nautilus hyprshot unzip brightnessctl xsensors
