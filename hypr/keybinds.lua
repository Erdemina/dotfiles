...
hl.bind(mod .. " + SHIFT + W",     hl.dsp.exec_cmd(shot .. " menu"),   { description = "Screenshot menu (same key as KDE)" })
...
local brightness = scripts .. "/brightness.sh"   -- OSD bildirimli (volume.sh gibi)
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd(brightness .. " up"),   held)
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd(brightness .. " down"), held)
